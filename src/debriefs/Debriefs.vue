<template>
    <div class="container">
        <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item"><router-link :to="{ name: 'Debrief8' }" class="btn btn-primary">Project 8</router-link></li>
            <li class="list-group-item"><router-link :to="{ name: 'Debrief9' }" class="btn btn-primary">Project 9</router-link></li>
            ...
            <li class="list-group-item"><router-link :to="{ name: 'Debrief14' }" class="btn btn-primary">Project 14</router-link></li>
            <li class="list-group-item"><router-link :to="{ name: 'Debrief15' }" class="btn btn-primary">Project 15</router-link></li>
            <li class="list-group-item"><router-link :to="{ name: 'Debrief16' }" class="btn btn-primary">Project 16</router-link></li>
